...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var gg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('gg'));
		add(gg);
		...
		leftArrow = new FlxSprite(486 - 50, grpWeekText.members[0].y + 10);
		...
		rightArrow = new FlxSprite(486 + 310, grpWeekText.members[0].y + 10);
